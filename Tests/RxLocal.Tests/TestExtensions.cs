...
namespace RxLocal.Tests
{
    public static class TestExtensions
    {
        ...
        public static T ShouldBeLessThan<T>(this T actual, T expected) where T : IComparable
        {
            Assert.Less(actual, expected);
            return actual;
        }

        public static T ShouldBeLessThanOrEqual<T>(this T actual, T expected) where T : IComparable
        {
            Assert.LessOrEqual(actual, expected);
            return actual;
        }

        public static T ShouldBeGreaterThan<T>(this T actual, T expected) where T : IComparable
        {
            Assert.Greater(actual, expected);
            return actual;
        }

        public static T ShouldBeGreaterThanOrEqual<T>(this T actual, T expected) where T : IComparable
        {
