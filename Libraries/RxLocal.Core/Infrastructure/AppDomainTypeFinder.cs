...
{
    /// <summary>
    /// A class that finds types needed by RxLocal by looping assemblies in the 
    ...
    public class AppDomainTypeFinder : ITypeFinder
    {
        ...
        private void AddAssembliesInAppDomain(ICollection<string> addedAssemblyNames, ICollection<Assembly> assemblies)
        {
            ...
            {
                if (!Matches(assembly.FullName) || addedAssemblyNames.Contains(assembly.FullName)) continue;
        ...
        protected virtual bool DoesTypeImplementOpenGeneric(Type type, Type openGeneric)
        {
            try
            {
                ...
                return type.FindInterfaces((objType, objCriteria) => true, null)
                    ...
                    .Select(i => genericTypeDefinition.IsAssignableFrom(i.GetGenericTypeDefinition()))
                    .FirstOrDefault();
            }
            catch
            {
